  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "font-bold px-4 py-2 rounded-xl border border-neutral-600 text-black bg-white hover:bg-gray-100 transition duration-200",
        secondary:
          "inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-[#364f6b] bg-[linear-gradient(110deg,#a6c1ee,45%,#85a3d8,55%,#a6c1ee)] bg-[length:200%_100%] px-6 font-bold text-[#364f6b] transition-colors focus:outline-none focus:ring-2 focus:ring-[#85a3d8] focus:ring-offset-2 focus:ring-offset-[#e8f1fb]",
